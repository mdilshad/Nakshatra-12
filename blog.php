				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="features.php">Features<span class="subheader">Awesome options</span></a>
								<ul>
									
									<li><a href="features-columns.php"><span> Columns layout</span></a></li>
							...
							<li class="current-menu-item"><a href="blog.php">Blog<span class="subheader">Read our posts</span></a></li>
							<li><a href="portfolio.php">Portfolio <span class="subheader">Showcase work</span></a></li>
							<li><a href="gallery.php">Gallery<span class="subheader">Featured work</span></a>
								<ul>
									<li><a href="gallery.php"><span> Four columns</span></a></li>
									<li><a href="gallery-3.php"><span> Three columns </span></a></li>
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<div id="posts">
							...
							<!-- post -->
							<div class="post">
								<h1><a href="single.php">Lorem ipsum dolor amet</a></h1>
								...
								<div class="thumb-shadow">
									...
									<div class="post-thumbnail">
										...
										<!-- ENDS meta -->
										<a href="single.php" class="cover"><img src="img/dummies/596x270.gif"  alt="Feature image" /></a>
									</div>
									<!-- ENDS post-thumb -->
									...
									<a href="single.php" class="read-more link-button"><span>Read more</span></a>	
					...
					<ul id="footer-cols">
						<li class="col">
							...
							<ul>
								...
								<li class="page_item"><a href="features.php">Features</a></li>
								<li class="page_item"><a href="blog.php">Blog</a></li>
								<li class="page_item"><a href="portfolio.php">Portfolio</a></li>
								<li class="page_item"><a href="gallery.php">Gallery</a></li>
