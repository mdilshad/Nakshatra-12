...
<label>
<strong>Name</strong>
<input type="text" placeholder="Enter your name here" name="teamLeader">
</label><br />
<label>
...
<label>
<strong>Email</strong>
<input type="text" placeholder="Your E-mail id" name="emailId">
</label><br />
<label>
...
<input type="password" placeholder="phone no" name="passwd">
</label><br />
<strong>confirm password</strong>
<input type="password" placeholder="phone no" name="cpasswd">
</label><br />
