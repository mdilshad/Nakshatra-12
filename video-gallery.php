				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="blog.php">Blog<span class="subheader">Read our posts</span></a></li>
							<li><a href="portfolio.php">Portfolio <span class="subheader">Showcase work</span></a></li>
							<li class="current-menu-item"><a href="gallery.php">Gallery<span class="subheader">Featured work</span></a>
								<ul>
